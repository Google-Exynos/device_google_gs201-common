...
DEVICE_PACKAGE_OVERLAYS += device/google/gs201-common/overlay-factory

PRODUCT_COPY_FILES += \
    device/google/gs201-common/conf/init.factory.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/init.factory.rc
